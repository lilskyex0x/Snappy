...
ActiveRecord::Schema[7.1].define(version: 2024_01_15_125323) do
  ...
  create_table "categories_transactions", force: :cascade do |t|
    ...
    t.bigint "transaction_ref_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["category_id"], name: "index_categories_transactions_on_category_id"
    t.index ["transaction_ref_id"], name: "index_categories_transactions_on_transaction_ref_id"
  end
